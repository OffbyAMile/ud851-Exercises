...
public class NotificationUtils {
	...
	/*
	* when calling the method clearAllNotifications you must pass in (Context context)
	followed by the notification manager instance in the brackets...
		example:
	...
	/*
	The next two methods will be called and created to handle the action buttons in
	...
	// (8) Create a PendingIntent from the intent to launch WaterReminderIntentService
		...
		// Note to self when creating this PendingIntent, there was only one error
		// it was on ACTION_IGNORE_PENDING_INTENT_ID...not sure but i believe this is caused
		// by the fact there is not a String for ACTION_IGNORE_PENDING_INTENT_ID yet added to the WaterReminderIntentService,

		// TODO: Come back and check the status of this String after completing the call and variable in the service WaterReminderIntentService
	...
	// (10) Return the action
		return ignoreReminderAction(context);
	}
	...
	private static NotificationCompat.Action drinkWaterAction(Context context) {
		...
		return new NotificationCompat.Action(R.drawable.ic_local_water_black_24dp,
				"I did it!",
    ...
    private static Bitmap largeIcon(Context context) {
		...
		return BitmapFactory.decodeResource(res, R.drawable.ic_local_water_black_24dp);
    }
}
