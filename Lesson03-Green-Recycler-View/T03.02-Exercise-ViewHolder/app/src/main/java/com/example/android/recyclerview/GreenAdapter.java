...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // C(1) Create a layout resource in res/layout/ called number_list_item.xml

    // Do steps 2 - 11 within number_list_item.xml
    // C (2) Make the root layout a FrameLayout
    // C (3) Make the width match_parent and the height wrap_content
    // C(4) Set the padding to 16dp
