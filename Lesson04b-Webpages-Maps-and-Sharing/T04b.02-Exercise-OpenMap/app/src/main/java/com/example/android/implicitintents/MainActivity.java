...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // FINISHED (5) Store an address in a String
        String searchAddress = "13110 Swift Road, MO";
        ...
        // FINISHED (6) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address

        // FINISHED (7) Replace the Toast with a call to showMap, passing in the Uri from the previous step
    ...
    // Do steps 2 - 4 within the showMap method
        // FINISHED (2) Create an Intent with action type, Intent.ACTION_VIEW

        // FINISHED (3) Set the data of the Intent to the Uri passed into this method

        // FINISHED (4) Verify that this Intent can be launched and then call startActivity
