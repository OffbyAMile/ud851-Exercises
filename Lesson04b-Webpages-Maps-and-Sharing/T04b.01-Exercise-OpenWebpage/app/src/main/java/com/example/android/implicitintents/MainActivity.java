...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // COMPLETE (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
            String urlAsString = "https://google.com";
    ...
    private void openWebPage(String url) {
        ...
        // COMPLETE Use Uri.parse to parse the String into a Uri

        // COMPLETE Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters

        // COMPLETE Verify that this Intent can be launched and then call startActivity
}