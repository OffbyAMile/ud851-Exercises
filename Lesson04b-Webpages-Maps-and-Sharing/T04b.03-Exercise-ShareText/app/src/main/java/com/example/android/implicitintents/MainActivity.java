...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // FINISHED (5) Specify a String you'd like to share
        String textToShare = "This course from Google and Udacity is so well put together, I am learning a lot!";
    ...
    private void shareText(String shareText) {
        ...
        // FINISHED (2) Create a String variable called mimeType and set it to "text/plain"

        // FINISHED (3) Create a title for the chooser window that will pop up

        // FINISHED (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
}
