...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETE Use the getIntent method to store the Intent that started this Activity in a variable
        ...
        // COMPLETE Create an if statement to check if this Intent has the extra we passed from MainActivity
