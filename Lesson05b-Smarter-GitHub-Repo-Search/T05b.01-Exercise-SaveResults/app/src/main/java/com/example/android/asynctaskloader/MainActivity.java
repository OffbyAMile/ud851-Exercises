...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String jsonResult = savedInstanceState.getString(SEARCH_RESULTS_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        //Make a variable that holds the content of raw JSON search results
        //This is done by calling String "Variable name" = "the already called variable.getText.toString
        String jsonResult = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULTS_JSON, jsonResult);
